...
extern int shift_l;     /* l shift state	*/
extern int shift_r;     /* r shift state	*/
extern int alt_l;       /* l alt state		*/
extern int alt_r;       /* r left state		*/
extern int ctrl_l;      /* l ctrl state		*/
extern int ctrl_r;      /* l ctrl state		*/
extern int caps_lock;   /* Caps Lock		*/
extern int num_lock;    /* Num Lock		*/
extern int scroll_lock; /* Scroll Lock		*/
extern int column;
